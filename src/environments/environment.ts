...
export const environment = {
  ...
  // Main
  apiBaseUrl: "https://x72q8vsb3i.execute-api.us-east-1.amazonaws.com/dev/api/",
  // apiBaseUrl: "https://aws-lamda.influxiq.com/dev/api/",
  pagination: [20, 50, 100, 200, 500],
  logo: "https://x72q8vsb3i.execute-api.us-east-1.amazonaws.com/dev/api/",
  siteTitle: "Pm-tool",
  footerText: "PM-Tool Copyright 2020",
  production: true,
